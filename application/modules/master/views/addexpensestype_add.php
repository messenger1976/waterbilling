<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL?>addexpensestype/">Expenses Type</a></li>
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addexpensestype Add</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addexpensestype Add <span class="fw-300"><i>Details</i></span></h2>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-12">
								...
								<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<h5 class="mb-3">Expensestype-Add </h5>
															...
															<div class="form-group col-lg-6">
																<div class="col-lg-12 controls">
																	<div class="form-group">
																		...
																		<input class="form-control" type="text" id="expensetype" name="expensetype" value="<?php echo $this->input->post('expensetype'); ?>" required/>
													...
													<div class="form-group mt-3">
														<div class="row">
															<div class="col-md-12">
																 ...
																 <a href="<?php echo ADMIN_URL;?>addexpensestype" class="btn btn-secondary">Cancel</a>
