<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addsubaccountgroup Edit</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addsubaccountgroup Edit <span class="fw-300"><i>Details</i></span></h2>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-12">
								...
								<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<h5 class="mb-3">Sub Account Group-Edit </h5>
																...
																<div class="form-group">
																	...
																	<select name="account_id" id="account_id" class="form-control" required>
                                                                     ...
                                                                     <?php foreach($account as $key => $value){?>
																	  <option value="<?php echo $value['id'];?>" <?php if($value['id'] == $record['account_id'] ){echo 'selected';}?>><?php echo $value['group_name'];?></option>
                                                                      <?php } ?>
																	</select>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	...
																	<input class="form-control" type="text" id="subaccountname" name="subaccountname" value="<?php echo $record['account_name']; ?>" required/>
