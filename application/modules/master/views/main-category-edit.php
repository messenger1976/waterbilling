<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Main Category Edit</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr"><h2>Main Category Edit</h2>
							...
							<div class="col-12">
								...
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="category_name" name="category_name" class="col-10 col-sm-5" value="<?php echo stripslashes($record['name']); ?>" required/>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label>
                                                <input name="status" id="status" type="radio" class="checkbox" value="1" <?php if($record['status'] =='1'){ ?> checked="checked" <?php } ?> />
                                                <span class="lbl"> Active</span></label><label>
                                                <input name="status" id="status" type="radio" class="checkbox" value="0" <?php if($record['status'] =='0'){ ?> checked="checked" <?php } ?> />
