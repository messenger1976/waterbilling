<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Practise Edit</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr"><h2>Practise Edit</h2>
                            ...
                            <?php } ?>	
								<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="<?php echo ADMIN_URL;?>practise/edit/<?php echo $record['id']; ?>" enctype="multipart/form-data">
								    ...
								    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" name="title" class="col-10 col-sm-5" value="<?php echo stripslashes($record['title']); ?>" required/>
