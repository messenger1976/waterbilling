<?php
	...
	$sa4_panel_id = 'panel-leakingentry-ledger';
...
<main id="js-page-content" role="main" class="page-content">
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			<div class="col-xl-12">
				<div id="panel-leakingentry-ledger" class="panel">
					<div class="panel-hdr">
						<h2>Manage Leaking Ledger <span class="fw-300"><i>Details</i></span></h2>
						<div class="panel-toolbar">
							<a href="<?php echo ADMIN_URL; ?>Leakingentry" class="btn btn-danger btn-sm waves-effect waves-themed mr-1">
