...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Employee Logins <span class="fw-300"><i>Add</i></span></h2>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="employee_name" name="employee_name" placeholder="Employee Name" value="<?php echo htmlspecialchars((string) $this->input->post('employee_name')); ?>" required>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="username" name="username" placeholder="User Name" value="<?php echo htmlspecialchars((string) $this->input->post('username')); ?>" required>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="mobile" name="mobile" placeholder="Mobile" value="<?php echo htmlspecialchars((string) $this->input->post('mobile')); ?>" required maxlength="10">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="roles" id="roles" required>
											...
											<?php
											$posted_roles = (string) $this->input->post('roles');
											foreach ($roles as $role_row) {
												$opt_val = $role_row['id'].'**'.$role_row['role_name'];
											?>
											<option value="<?php echo htmlspecialchars($opt_val); ?>" <?php echo ($posted_roles === $opt_val) ? 'selected' : ''; ?>>
