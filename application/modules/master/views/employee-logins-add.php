		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>employee_logins/">Employee Logins</a></li>
					<li>add</li>
				</ol>
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<legend>Employee Logins-Add </legend>
														<div class="form-group col-lg-12">
															<div class="col-lg-6 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Employee Name : </strong></span>
														...
														<div class="form-group col-lg-12">
															<div class="col-lg-6 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Password : </strong></span>
														...
														<div class="form-group col-lg-12">
															<div class="col-lg-6 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Mobile : </strong></span>
														...
														<div class="form-group col-lg-12">
															<div class="col-lg-6 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Roles : </strong></span>
