<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Paymentmonthlycustomer Edit</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr"><h2>Paymentmonthlycustomer Edit</h2>
                            ...
                            <?php } ?>	
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="plan_name" name="plan_name" class="col-10 col-sm-10" value="<?php echo $record['plan_name']; ?>" required/>
									...
									<!--<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">  After Meter : </label>
										<div class="col-sm-8">
											<input type="text" id="aftermeter" name="aftermeter" class="col-10 col-sm-10" value="<?php echo $record['aftermeter']; ?>" required/>
									...
									<div class="form-group">
										<label class="col-sm-4 control-label no-padding-right" for="form-field-1">  Balance : </label>
										<div class="col-sm-8">
											<input type="text" id="balance" name="balance" class="col-10 col-sm-10" value="<?php echo $record['balance']; ?>" required/>
							...
							<div class="clearfix form-actions">
								<div class="space-4"></div>
                                        ...
                                        <input type="submit" class="btn btn-sm btn-primary" name="add" id="add" value="Edit">
											&nbsp; &nbsp; &nbsp;
                                            <a href="<?php echo ADMIN_URL;?>paymentmonthlycustomer" class="btn btn-sm btn-danger">Cancel</a>
										</div>
									</div>
						</div><!-- /.row -->
						</form>
