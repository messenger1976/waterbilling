...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Roles &amp; Permissions <span class="fw-300"><i>Edit</i></span></h2>
					...
					<div class="panel-content">
						<form name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
							<div class="form-group col-md-6 px-0">
								...
								<input class="form-control" type="text" id="role_name" name="role_name" value="<?php echo htmlspecialchars(isset($record['role_name']) ? stripslashes($record['role_name']) : ''); ?>" required maxlength="50">
