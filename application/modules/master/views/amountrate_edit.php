<?php
	...
	$class_id = $this->input->post('classification') != ''
		? $this->input->post('classification')
		: (isset($record['classification_id']) ? $record['classification_id'] : '');
	$cubic_meter = $this->input->post('cubic_meter') != ''
		? $this->input->post('cubic_meter')
		: (isset($record['cubic_meter']) ? $record['cubic_meter'] : '');
	$amountrate = $this->input->post('amountrate') != ''
		? $this->input->post('amountrate')
		: (isset($record['per_unit']) ? $record['per_unit'] : '');
?>
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-amountrate-edit" class="panel">
				<div class="panel-hdr">
					<h2>Meter Rate <span class="fw-300"><i>Edit</i></span></h2>
				...
				<div class="panel-container show">
					<div class="panel-content">
						...
						<div class="alert alert-warning mb-0" role="alert">
							Record not found. <a href="<?php echo ADMIN_URL; ?>amountrate">Back to listing</a>
						</div>
						<?php } else { ?>
						<form name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="classification" id="classification" required>
											...
											<option value="<?php echo (int) $value['class_id']; ?>" <?php echo ((string) $class_id === (string) $value['class_id']) ? 'selected' : ''; ?>>
												<?php echo htmlspecialchars($value['class_name']); ?>
											</option>
											<?php } ?>
										</select>
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="form-label" for="cubic_meter">Cubic Meter</label>
										<input class="form-control" type="number" id="cubic_meter" name="cubic_meter" value="<?php echo htmlspecialchars($cubic_meter); ?>" min="0" required>
										<?php echo form_error('cubic_meter'); ?>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="form-label" for="amountrate">Meter Rate</label>
										<input class="form-control" type="number" step="0.01" id="amountrate" name="amountrate" value="<?php echo htmlspecialchars($amountrate); ?>" min="0" required>
