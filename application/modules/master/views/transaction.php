<?php
	...
	$sa4_page_subtitle = 'Transaction';
	$sa4_loading_label = 'Transaction';
	$sa4_dt_entity = 'transaction';
	$sa4_panel_id = 'panel-transaction';
?>
...
<?php include(__DIR__ . '/partials/sa4_kpi_subheader.php'); ?>
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			<div class="col-xl-12">
				<div id="panel-transaction" class="panel">
					<div class="panel-hdr">
						<h2>Transaction <span class="fw-300"><i>Listing</i></span></h2>
													...
													<tr>
														...
														<td>
														    ...
														    <div class=" action-buttons">
																...
																<a class="red" href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='<?php echo ADMIN_URL;?>addexpenses/delete/<?php echo $row['id'];?>';}">
