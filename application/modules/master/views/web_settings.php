<?php
	$sa4_loading_label = 'Web Settings';
	$sa4_dt_entity = 'web settings';
	$sa4_panel_id = 'panel-web-settings';
	$sa4_dt_export_cols = array(0, 1);
...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-web-settings" class="panel">
				<div class="panel-hdr">
					<h2>Web Settings <span class="fw-300"><i>Listing</i></span></h2>
							...
							<tbody>
								<?php if (count($records) > 0) {
									...
									foreach ($records as $row) {
										$raw = isset($row['content']) ? stripslashes(str_replace('\n', '', $row['content'])) : '';
								...
								<tr>
									...
									<td>
										<a class="btn btn-outline-success btn-sm" href="<?php echo ADMIN_URL; ?>web_settings/edit/<?php echo $row['id']; ?>" title="Edit" data-toggle="tooltip">
