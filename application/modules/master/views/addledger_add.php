		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL;?>addledger/">Ledger</a></li>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-pencil-square-o fa-fw"></i>add <span>>  Ledger </span></h1>
					</div>
					<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
						<ul id="sparks" class="">
							...
							?>
								<h5> Income <span class="txt-color-blue">PHP <?php print_r(number_format($intotal));?></span></h5>
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<legend>Ledger-Add </legend>
                                                     <div class="form-group col-lg-6">
														<div class="col-lg-12 controls">
															<div class="form-group">
																<span class="input-group-addon"><i class="icon-user"></i><strong>Account Subgroup Type : </strong></span>
													...
													<div class="form-group col-lg-6">
														<div class="col-lg-12 controls">
															<div class="form-group">
																<span class="input-group-addon"><i class="icon-user"></i><strong>Name of Ledger : </strong></span>
													...
													<div class="form-group col-lg-6">
														<div class="col-lg-12 controls">
															<div class="form-group">
																<span class="input-group-addon"><i class="icon-user"></i><strong>OP Balance : </strong></span>
													...
													<div class="form-actions">
														<div class="row">
															<div class="col-md-12">
																 ...
																 <a href="<?php echo ADMIN_URL;?>addledger" class="btn btn-default">Cancel</a>
	...
	if(ledgerName!=''){
		...
		$.ajax({
				...
				success: function(data) {
								//alert(data);
								if(data=='true'){
									$("#val_roll_img").text('').attr("class","label label-warning").text( "ledgerName '"+ ledgerName +" ' already exists try another !" );
									$("#ledgerName").val('').focus();
								} else {
									$("#val_roll_img").removeAttr("class").text('').attr("class","label label-success").text( "Ledger Name  '"+ ledgerName +" ' available !" );
								}
