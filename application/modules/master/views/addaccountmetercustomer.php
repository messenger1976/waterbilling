<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addaccountmetercustomer</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addaccountmetercustomer <span class="fw-300"><i>Details</i></span></h2>
						...
						<div class="col-sm-6 col-lg-12">
								...
								<div class="panel panel-default">
											...
											<fieldset><?php extract($id);?>
														...
														<form method="POST" action="<?php echo ADMIN_URL;?>addpaymentcustomer/saveaccountmetercustomer">
