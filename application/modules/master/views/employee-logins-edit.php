...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Employee Logins <span class="fw-300"><i>Edit</i></span></h2>
					...
					<div class="panel-content">
						<form name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="emp_name" name="emp_name" value="<?php echo htmlspecialchars(isset($record['employee_name']) ? $record['employee_name'] : ''); ?>" required>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="username" name="username" placeholder="User Name" value="<?php echo htmlspecialchars(isset($record['username']) ? $record['username'] : ''); ?>" required>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="password" id="password" name="password" value="" placeholder="Leave blank to keep current">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="mobile" name="mobile" value="<?php echo htmlspecialchars(isset($record['mobile']) ? $record['mobile'] : ''); ?>" required maxlength="10">
									...
									<div class="form-group">
										...
										<select class="form-control" name="roles" id="roles" required>
											...
											<?php foreach ($roles as $role_row) {
												$opt_val = $role_row['id'].'**'.$role_row['role_name'];
												$selected = (isset($record['role_id']) && (string) $record['role_id'] === (string) $role_row['id']) ? 'selected' : '';
											?>
											<option value="<?php echo htmlspecialchars($opt_val); ?>" <?php echo $selected; ?>>
							...
							<div class="form-group mb-0">
								<a href="<?php echo ADMIN_URL; ?>employee_logins/" class="btn btn-secondary">
