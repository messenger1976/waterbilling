<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addpaymentcustomer Edit</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr"><h2>Addpaymentcustomer Edit</h2>
                      ...
                      <div class="col-12">
                            ...
                            <?php } ?>	
								...
								<div class="form-group">
										...
										<div class="col-sm-8">
											 <select name="name" id="name" class="col-10 col-sm-10" required onchange="getcustomeroldmeter(this.value);">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="oldmeter" name="oldmeter" class="col-10 col-sm-10" value="<?php echo $record['oldmeter']; ?>" required/>
