<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addexpensestype Edit</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addexpensestype Edit <span class="fw-300"><i>Details</i></span></h2>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-12">
								...
								<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<h5 class="mb-3">Expenses Type-Edit </h5>
														...
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	...
																	<input class="form-control" type="text" id="expensetype" name="expensetype" value="<?php echo $record['expensestype_name']; ?>" required/>
													...
													<div class="form-group mt-3">
														<div class="row">
															<div class="col-md-12">
																 ...
																 <a href="<?php echo ADMIN_URL;?>addaccountgroup" class="btn btn-secondary">Cancel</a>
