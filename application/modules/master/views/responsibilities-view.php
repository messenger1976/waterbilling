<?php
	...
	$can_edit = ($this->session->userdata('usertype') == 'admin')
		|| (isset($roleResponsible['admin']) && is_array($roleResponsible['admin']) && in_array('e', $roleResponsible['admin']));
?>
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Roles &amp; Permissions <span class="fw-300"><i>View</i></span></h2>
					...
					<div class="panel-content">
						<form name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
							<div class="form-group col-md-6 px-0">
								...
								<input class="form-control" type="text" id="role_name" name="role_name" value="<?php echo htmlspecialchars(isset($record['role_name']) ? stripslashes($record['role_name']) : ''); ?>" required maxlength="50" readonly>
							</div>

							<?php include(dirname(__FILE__).'/responsibilities-permissions.php'); ?>

							<div class="form-group mb-0 mt-3">
								<?php if ($can_edit && !empty($record['id'])) { ?>
								<a href="<?php echo ADMIN_URL; ?>responsibilities/edit/<?php echo $record['id']; ?>" class="btn btn-primary">
									<i class="fal fa-edit mr-1"></i> Edit
								</a>
								<?php } ?>
								<a href="<?php echo ADMIN_URL; ?>responsibilities/" class="btn btn-secondary">
