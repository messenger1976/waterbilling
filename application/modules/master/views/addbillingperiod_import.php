...
<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL; ?>addbillingperiod">Billing Period</a></li>
	...
	<div class="subheader">
		<h1 class="subheader-title">
			<i class="subheader-icon fal fa-file-import"></i>
			Manage <span class="fw-300">Billing Period Import</span>
		</h1>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Import Billing Period <span class="fw-300"><i>CSV</i></span></h2>
					...
					<div class="panel-content">
						<form action="<?php echo ADMIN_URL; ?>addbillingperiod/upload" method="post" enctype="multipart/form-data">
							<div class="form-group col-md-6 px-0">
								<label class="form-label" for="csv_file">Import File</label>
							...
							<div class="form-group mb-0">
								...
								<button type="submit" class="btn btn-primary" name="import" id="import" value="Import">
									<i class="fal fa-file-import mr-1"></i> Import
								</button>
							</div>
						</form>
					</div>
