...
<div class="row">
 ...
 <div align="right" style="font-size:16px; text-decoration:none;"><img src="<?php echo site_url();?>/assets/images/print-icon.png" width="21" height="21" border="0" /> <a href="<?php echo site_url();?>master/payrols/printInvoice/<?php echo $this->uri->segment(4)?>" class="order-summary" style="font-size:12px;" target="_blank" >Print</a>
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dcdcdc">
              <thead>
                <tr class="table-heading">
                  ...
                  <th width="22%" align="left" valign="middle" bgcolor="#ececec">Employee ID</th>
                  <th width="16%" align="left" valign="middle" bgcolor="#ececec">Employee Details</th>
                  ...
                  <th width="9%" align="left" valign="middle" class="center" bgcolor="#ececec">Month</th>
                  <th width="10%" align="left" valign="middle" class="center" bgcolor="#ececec">Title</th>
              ...
              <tbody>  
                <tr class="odd gradeX">
                  ...
                  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right">
				    <?php echo $record['month']; ?><br>
				  </td>
				  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right"><?php echo stripslashes($record['title']); ?></td>
                  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right">
					<?php
