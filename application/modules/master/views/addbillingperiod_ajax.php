                                            ...
                                            <table  id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
												<thead>
													<tr>
														...
														<th data-hide="disconnectiondate">Disconnection Date </th>
                                                ...
                                                ?>                                            
													<tr>
														...
														<td><?php echo stripslashes($row['bp_start_date']); ?></td>
														<td><?php echo stripslashes($row['bp_end_date']); ?></td>
														<td><?php echo stripslashes($row['bp_due_date']); ?></td>
