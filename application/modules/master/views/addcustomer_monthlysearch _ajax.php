        ...
        <table  id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
			<thead>
				<tr>
					...
					<th data-hide="expand">Mobile2</th>
					...
					<th data-hide="expand">Total Paid Amount</th>
			...
			<tr>
				<td><?php echo $i; ?></td>
				<td align="left"><?php echo stripslashes($row['customer_id']); ?></td>
				<td align="left"><?php echo stripslashes($row['first_name']); ?></td>																												
				<td align="left"><?php echo stripslashes($row['gender']); ?></td>
				<td align="left"><?php echo stripslashes($row['mobile1']); ?></td>
				<td align="left"><?php echo stripslashes($row['mobile2']); ?></td>
				<td align="left"><?php echo stripslashes($row['email_id']); ?></td>
				<td align="left"><?php echo stripslashes($row['address']); ?></td>
				<td align="left"><?php echo stripslashes($row['amount']); ?></td>
				<td align="left"><?php echo stripslashes($row['balance']); ?></td>
				<td align="left"><?php echo stripslashes($row['paidamount']); ?></td>
				<td><span <?php if($row['balance']== 0){ 
				         echo " class='badge badge-success arrowed-in arrowed-in-right'"; 
						 } elseif($row['balance']!= 0){ 
						   echo "class='badge badge-danger arrowed'"; 
						 } ?> ><!--<a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>paymentmonthlycustomer/status/<?php echo $row['id']?>/<?php echo $row['status'];?>/<?php echo $row['customer_id'];?>';
