							...
							<div>
								...
								<div class="space-4"></div>
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a href="<?php echo ADMIN_URL;?>addemployee/edit/<?php echo $record['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <a href="<?php echo ADMIN_URL;?>addemployee" class="btn btn-sm btn-danger">Cancel</a>
										</div>
									</div>
						</div><!-- /.row -->
