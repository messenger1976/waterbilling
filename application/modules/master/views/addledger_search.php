<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addledger Search</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addledger Search <span class="fw-300"><i>Details</i></span></h2>
											...
											<fieldset>
												...
												<div class="float-right" style="padding-right:20px;">
													...
													<div class="form-group mt-3">
														<div class="row">
															<div class="col-md-12">
																<input type="submit" class="btn btn-primary" name="search" id="search" value="search" onclick="getaddemployee();">
															</div>
														</div>
