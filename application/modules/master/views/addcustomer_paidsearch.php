<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addcustomer Paidsearch</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addcustomer Paidsearch <span class="fw-300"><i>Details</i></span></h2>
										...
										<div class="form-horizontal" >
											...
											<fieldset>
												...
												<div class="pull-right" style="padding-right:20px;">
														...
														<a href="<?php echo ADMIN_URL;?>addcustomer/fileDownloadpaidSerch/<?php if($this->input->post('customer_type')!=''){ echo $this->input->post('customer_type'); }else{ echo 0;} ?>/<?php if($this->input->post('zone')!=''){ echo $this->input->post('zone'); }else{ echo 0;} ?>/<?php if($this->input->post('fromdate')!=''){ echo $this->input->post('fromdate'); }else{ echo 0;} ?>/<?php if($this->input->post('todate')!=''){ echo $this->input->post('todate'); }else{ echo 0;} ?>
																			"class="btn btn-sm btn-primary" style="margin-bottom: 4px;">Export Excel</a>
														<a href="<?php echo ADMIN_URL;?>addcustomer/filePrintpaidSerch/<?php if($this->input->post('customer_type')!=''){ echo $this->input->post('customer_type'); }else{ echo 0;} ?>/<?php if($this->input->post('zone')!=''){ echo $this->input->post('zone'); }else{ echo 0;} ?>/<?php if($this->input->post('fromdate')!=''){ echo $this->input->post('fromdate'); }else{ echo 0;} ?>/<?php if($this->input->post('todate')!=''){ echo $this->input->post('todate'); }else{ echo 0;} ?>
...
<script type="text/javascript">
		...
		function getaddcustomer_paid(){
			...
			$.ajax({
				...
				type : "POST",
				url	: '<?php echo ADMIN_URL;?>addcustomer/getaddcustomerspaidsearch',
