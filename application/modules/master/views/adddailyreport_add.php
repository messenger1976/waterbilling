...
<main id="js-page-content" role="main" class="page-content">
	<ol class="breadcrumb page-breadcrumb">
		...
		<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL; ?>adddailyreport/">Daily Report</a></li>
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Daily Report</span>
		</h1>
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-daily-report" class="panel">
				<div class="panel-hdr">
					<h2>Daily Report <span class="fw-300"><i>Bills Search</i></span></h2>
				...
				<div class="panel-container show">
					<div class="panel-content">
						<form name="daily_report_form" id="daily_report_form" method="post" action="javascript:void(0);">
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="form-label" for="cashier">Cashier / User</label>
										<select class="form-control" name="cashier" id="cashier">
											<option value="0">--All--</option>
											<?php if (!empty($cashier_list)) { ?>
...
$(document).ready(function(){
	...
	$('#printtopdf').on('click',function(evt){
		...
		const popup = window.open(
			"adddailyreport/printtopdf/"+fromdate+'/'+zone+'/'+preparedby+'/'+verifiedby+'/'+approvedby+'/'+grouping+'/'+cashier,
			"PopupWindowPrint",
	...
	$('#exporttoexcel').on('click',function(evt){
		...
		window.location.href = "<?php echo ADMIN_URL;?>adddailyreport/exporttoexcel/"+fromdate+'/'+zone+'/'+preparedby+'/'+verifiedby+'/'+approvedby+'/'+grouping+'/'+cashier;
	});
});
</script>
<script type="text/javascript">
	...
	function getaddcustomer_paid(){
		...
		$.ajax({
			...
			data	: "fromdate="+fromdate+"&zone="+zone+"&grouping="+grouping+"&cashier="+cashier,
