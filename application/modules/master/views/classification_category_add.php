		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL;?>classification_category">Classification Category</a></li>
					<li>add</li>
				</ol>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Classification Category-add </span></h1>
					</div>
							...
							<div class="panel panel-default">
								...
								<div class="widget-body">
									...
									<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
										...
										<fieldset>
													<legend>Classification Category-Add </legend>
													<div class="form-group col-lg-6">
														<div class="col-lg-12 controls">
															<div class="form-group">
																<span class="input-group-addon"><i class="icon-user"></i><strong>Classification Category Name:</strong></span>
																<input  class="form-control"  type="text" id="class_cat_name" name="class_cat_name" value="<?php echo $this->input->post('class_cat_name'); ?>" required/>
												...
												<div class="form-actions">
													<div class="row">
														<div class="col-md-12">
															 ...
															 <a href="<?php echo ADMIN_URL;?>classification_category" class="btn btn-default">Cancel</a>
