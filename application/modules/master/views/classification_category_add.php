<?php
	...
	$class_cat_name = $this->input->post('class_cat_name') != '' ? $this->input->post('class_cat_name') : '';
?>
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-classification-category-add" class="panel">
				<div class="panel-hdr">
					<h2>Classification Category <span class="fw-300"><i>Add</i></span></h2>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="class_cat_name" name="class_cat_name" value="<?php echo htmlspecialchars($class_cat_name); ?>" required>
