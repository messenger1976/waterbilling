<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Paymentmonthlycustomer Invoice</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr"><h2>Paymentmonthlycustomer Invoice</h2>
...
<div class="row">
							<div class="col-12">
								...
								<div class="row">
									<div class="col-12">
										<h3 class="header smaller lighter blue"><i><img src="<?php echo site_url();?>/assets/images/orders.png" width="23" height="24" /></i> Monthly Customer Invoice </h3>
										
                   <span style="font-weight:bold; color:#0F3;">   <?PHP echo $this->session->flashdata('msg_succ'); ?> </span>                 
                                        
 <div align="right" style="font-size:16px; text-decoration:none;"><img src="<?php echo site_url();?>/assets/images/print-icon.png" width="21" height="21" border="0" /> <a href="<?php echo site_url();?>master/paymentmonthlycustomer/printInvoice/<?php echo $this->uri->segment(4)?>" class="order-summary" style="font-size:12px;" target="_blank" >Print</a>
 ...
 <td width="25%"> <strong>Pay status</strong></td>
            ...
            <td align="left" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dcdcdc">
              <thead>
                <tr class="table-heading">
                  ...
                  <th width="16%" align="left" valign="middle" bgcolor="#ececec">Plan Details</th>			  
                  <th width="8%" align="left" valign="middle" bgcolor="#ececec">Amount</th>
                  <th width="9%" align="left" valign="middle" class="center" bgcolor="#ececec">Balance</th>
                  <th width="8%" align="left" valign="middle" class="center" bgcolor="#ececec">Total</th>
                  <th width="10%" align="left" valign="middle" class="center" bgcolor="#ececec">Status</th>
              ...
              <tbody>  
                <tr class="odd gradeX">
                  ...
                  <td height="30" align="left" valign="middle" bgcolor="#FFFFFF" class="forgotpassword">
					<b>Plan Name :</b> <?php echo stripslashes($record['plan_name']); ?><br/>
                  </td>				  
                  ...
                  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right">
				    <?php echo $record['balance']; ?><br>
				  </td>
                  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right">   
					<?php echo stripslashes($record['total']); ?>
				  </td>
				  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right"><?php 					
				  if($record['status'] == '1'){
						echo "Paid";
					}if($record['status'] == '0'){
						echo "Un-Paid";
                  ...
                  <td align="right" valign="middle" bgcolor="#FFFFFF" class="right">
					<?php
					echo date("M d, Y ", strtotime($record['create_date_time'])) ;
