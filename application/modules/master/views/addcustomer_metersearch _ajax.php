                                            ...
                                            <table  id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
												<thead>
													<tr>
														...
														<th data-hide="expand">Customer-Type</th>
														<th data-hide="expand">Aqrin Hore</th>
														<th data-hide="expand">Aqrin dambe</th>
														<th data-hide="expand">Amount</th>
														<th data-hide="expand">Balance</th>
														<th data-hide="expand">Pay Amount</th>
                                                ...
                                                ?>                                            
													<tr>
														...
														<td>
														<span <?php if($row['status']== 1){ echo " class='badge badge-success arrowed-in arrowed-in-right'"; } elseif($row['status']== 0){ echo "class='badge badge-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the Status?')==true){window.location='<?php echo ADMIN_URL;?>addpaymentcustomer/status/<?php echo $row['id']?>/<?php echo $row['status'];?>/<?php echo $row['customer_id'];?>';}" style="color:#FFF; text-decoration:none;"> <?php if($row['status']== 1){ echo "Paid"; } elseif($row['status']== 0) { echo "Partial-Paid"; } ?></a></span></td>
