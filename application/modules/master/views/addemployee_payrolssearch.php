<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Addemployee Payrolssearch</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Addemployee Payrolssearch <span class="fw-300"><i>Details</i></span></h2>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-lg-12">
								...
								<div class="form-horizontal" >
											...
											<fieldset>
												<h5 class="mb-3">Payrols-search
												<div   class="float-right" style="padding-right:20px;">
													<input type="submit" class="btn btn-primary" name="search" id="search" value="search" onclick="getaddemployee_pay();" style="margin-bottom: 5px;">
													<a href="<?php echo ADMIN_URL;?>addemployee/fileDownloadajax1/<?php if($this->input->post('employee_id')!=''){ echo $this->input->post('employee_id'); }else{ echo 0;};?>"class="btn btn-sm btn-primary" style="margin-bottom: 4px;">Export Excel</a>
...
<script type="text/javascript">
		...
		function getaddemployee_pay(){
			...
			$.ajax({
				...
				type : "POST",
				url	: '<?php echo ADMIN_URL;?>addemployee/getaddemployeepayrolrssearch',
