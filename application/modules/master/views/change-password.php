<?php
	...
	$cur_pwd = (string) $this->input->post('cur_pwd');
	$new_pwd = (string) $this->input->post('new_pwd');
	$conf_pwd = (string) $this->input->post('conf_pwd');
?>
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-change-password" class="panel">
				<div class="panel-hdr">
					<h2>Password <span class="fw-300"><i>Update</i></span></h2>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="password" id="cur_pwd" name="cur_pwd" value="<?php echo htmlspecialchars($cur_pwd); ?>" required autocomplete="current-password">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="password" id="new_pwd" name="new_pwd" value="<?php echo htmlspecialchars($new_pwd); ?>" required autocomplete="new-password">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="password" id="conf_pwd" name="conf_pwd" value="<?php echo htmlspecialchars($conf_pwd); ?>" required autocomplete="new-password">
