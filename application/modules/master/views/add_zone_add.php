<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Add Zone Add</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Add Zone Add <span class="fw-300"><i>Details</i></span></h2>
						...
						<div class="col-sm-6 col-lg-12">
								...
								<div class="panel panel-default">
										...
										<form class="form-horizontal" role="form" name="myform" id="myform" method="post" action="" enctype="multipart/form-data">
											...
											<fieldset>
														<legend>Zone-Add </legend>
														<div class="form-group col-lg-6">
															<div class="col-lg-12 controls">
																<div class="form-group">
																	<span class="input-group-addon"><i class="icon-user"></i><strong>Zone:</strong></span>
																	<input  class="form-control"  type="text" id="zone" name="zone" value="<?php echo $this->input->post('zone'); ?>" required/>
