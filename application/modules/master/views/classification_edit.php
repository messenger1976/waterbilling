<?php
	...
	$class_name = $this->input->post('class_name') != ''
		...
		: (isset($record['class_name']) ? $record['class_name'] : '');
	$class_cat_id = $this->input->post('class_cat_id') != ''
		? $this->input->post('class_cat_id')
		: (isset($record['class_cat_id']) ? $record['class_cat_id'] : '');
?>
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-classification-edit" class="panel">
				<div class="panel-hdr">
					<h2>Classification <span class="fw-300"><i>Edit</i></span></h2>
				...
				<div class="panel-container show">
					<div class="panel-content">
						...
						<div class="alert alert-warning mb-0" role="alert">
							Record not found. <a href="<?php echo ADMIN_URL; ?>classification">Back to listing</a>
						</div>
						<?php } else { ?>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" id="class_name" name="class_name" value="<?php echo htmlspecialchars(stripslashes($class_name)); ?>" required>
