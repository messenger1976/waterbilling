		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>addemployee/add/">addemployee</a></li>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> View <span>> employee  </span></h1>
					</div>
					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<p style="padding: 5px 0 0 45px;font-size: 16px;"><strong>Manage Employee</strong>
								<button class="btn btn-sm btn-primary" style="float:right;"><a href="<?php echo ADMIN_URL?>addemployee/add/" style="color: #fff;"><i class="fa fa-plus"></i> Add Employee</a></button>
								</p>
								</header>
								...
								<div>
				                    ...
				                    <form method="post" action="<?php echo ADMIN_URL;?>addemployee/multi_delete">
										<!-- widget content -->
										   ...
										   <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
												...
												<thead>			                
													<tr>
														...
														<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Employee id</th>
...
$(document).on('click','.print_button',function(e){
	...
	if(empid != '' && employee_id != ''){
				var url = '<?php echo ADMIN_URL;?>addemployee/employee_register_form/'+empid+'/'+employee_id;
