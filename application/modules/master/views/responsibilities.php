		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<?php 
			              if(($this->session->userdata('usertype') == 'admin') || array_key_exists('admin',$roleResponsible) && ($roleResponsible['admin'] == 1)){ 
			        ?>	        
					<li><a href="<?php echo ADMIN_URL?>responsibilities/add/">Add Sub Admins</a></li>
					<?php } ?>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> View <span>>  Roles & Responsibilities </span></h1>
					</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<header style="height: 42px;">
									...
									<p style="padding: 5px 0 0 45px;font-size: 16px;"><strong>Responsibilities</strong>
									<button class="btn btn-sm btn-primary" style="float:right;"><a href="<?php echo ADMIN_URL?>responsibilities/add/" style="color: #fff;"><i class="fa fa-plus"></i> Add Responsibilities</a></button>
									</p>
								</header>
												...
												<tbody>
												  <?php
													...
													<tr>
														...
														<td>
															<?php if($row['status']== 1){ ?>
															<span <?php if($row['status']== 1){ echo " class='label label-success arrowed-in arrowed-in-right'"; } elseif($row['status']== 0){ echo "class='label label-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Change the Status?')==true){window.location='<?php echo ADMIN_URL;?>responsibilities/status/<?php echo $row['id']?>/<?php echo $row['status'];?>/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>';}" style="color:#FFF; text-decoration:none;">Active</a></span>
															...
															<span <?php echo "class='label label-danger arrowed'"; ?>><a href="" style="color:#FFF; text-decoration:none;">In-complete</a></span>
															<?php } ?>
                 										</td>
                                                        <td>
