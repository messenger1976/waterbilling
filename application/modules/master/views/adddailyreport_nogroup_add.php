		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL;?>adddailyreport_nogroup/">Daily Report - No grouping</a></li>
					<li>search</li>
				</ol>
...
$(document).ready(function(){
	...
	$('#printtopdf').on('click',function(evt){
		...
		const popup = window.open(
			"adddailyreport_nogroup/printtopdf/"+fromdate+'/'+preparedby+'/'+verifiedby+'/'+approvedby, // URL to display 
	...
	$('#exporttoexcel').on('click',function(evt){
		...
		window.location.href = "<?php echo ADMIN_URL;?>adddailyreport_nogroup/exporttoexcel/"+fromdate+'/'+preparedby+'/'+verifiedby+'/'+approvedby;
	});
});
...
<script type="text/javascript">
		...
		function getaddcustomer_paid(){
			...
			$.ajax({
				...
				type : "POST",
				url	: '<?php echo ADMIN_URL;?>adddailyreport_nogroup/getadddailyreportsearch',
