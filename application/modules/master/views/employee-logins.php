			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> View <span>> Employee Logins </span></h1>
					</div>
					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<p style="padding: 5px 0 0 45px;font-size: 16px;"><strong>Employee Logins</strong>
								<button class="btn btn-sm btn-primary" style="float:right;"><a href="<?php echo ADMIN_URL?>employee_logins/add/" style="color: #fff;"><i class="fa fa-plus"></i> Add Employee Login</a></button>
								</p>
								</header>
