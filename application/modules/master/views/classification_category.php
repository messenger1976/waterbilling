<?php
	$sa4_loading_label = 'Classification Category';
	$sa4_dt_entity = 'classification categories';
	$sa4_panel_id = 'panel-classification-category';
	$sa4_dt_export_cols = array(1, 2);
...
<main id="js-page-content" role="main" class="page-content">
	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-classification-category" class="panel">
				<div class="panel-hdr">
					<h2>Classification Category <span class="fw-300"><i>Listing</i></span></h2>
				...
				<div class="panel-container show">
					<div class="panel-content">
						<form method="post" action="<?php echo ADMIN_URL; ?>classification_category/multi_delete" id="sa4-list-form">
							<div class="row mb-3 align-items-end">
								...
								<div class="col-sm-6 text-right">
									<a href="<?php echo ADMIN_URL; ?>classification_category/add/" class="btn btn-success btn-sm waves-effect waves-themed">
										<i class="fal fa-plus mr-1"></i> Add Classification Category
									</a>
								</div>
							</div>
							...
							<table id="dt_basic" class="table table-bordered table-hover table-striped w-100">
								<thead>
									<tr>
										...
										<th>Classification Category Name</th>
								...
								<tbody>
									...
									?>
									<tr>
										<td><input type="checkbox" class="ace" name="delete_ids[]" value="<?php echo (int) $row['class_cat_id']; ?>" /></td>
										<td><?php echo $i; ?></td>
										<td><?php echo htmlspecialchars(stripslashes($row['class_cat_name'])); ?></td>
										<td>
											<div class="btn-group btn-group-sm" role="group">
												<a href="<?php echo ADMIN_URL; ?>classification_category/edit/<?php echo (int) $row['class_cat_id']; ?>" class="btn btn-outline-success" title="Edit" data-toggle="tooltip">
												...
												<a href="javascript:void(0);" class="btn btn-outline-danger btn-delete-row sa4-confirm-delete" title="Delete" data-toggle="tooltip"
													data-sa4-delete-url="<?php echo ADMIN_URL; ?>classification_category/delete/<?php echo (int) $row['class_cat_id']; ?>">
