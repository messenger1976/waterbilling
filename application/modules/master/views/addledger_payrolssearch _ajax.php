                                              ...
                                              <table  id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                                ...
                                                ?>                                            
													<tr>
														...
														<td><?php echo stripslashes($row['tax']); ?></td>
														<td><?php echo stripslashes($row['total']); ?></td>
														<td><?php echo stripslashes($row['title']); ?></td>
														<td><span <?php if($row['pay']== 1){ echo " class='badge badge-success arrowed-in arrowed-in-right'"; } elseif($row['pay']== 0){ echo "class='badge badge-danger arrowed'"; } ?>><a href="JavaScript:if(confirm('Are you sure want to Chanage the pay?')==true){window.location='<?php echo ADMIN_URL;?>addemployee/pay/<?php echo $row['id']?>/<?php echo $row['pay'];?>/<?php echo $this->uri->segment(3);?>';}" style="color:#FFF; text-decoration:none;"><?php if($row['pay']== 1){ echo "paid"; } elseif($row['pay']== 0){ echo "unpaid"; } ?></a></span></td>    
