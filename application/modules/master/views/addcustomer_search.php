		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo ADMIN_URL?>addcustomer/add/">Add Customer</a></li>
					<li>Search</li>
				</ol>
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="glyphicon glyphicon-search"></i>&nbsp; search <span>> Customer-Search  </span></h1>
					</div>
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
								...
								<div class="panel panel-default">
									...
									<div class="widget-body">
										...
										<div class="form-horizontal" >
											...
											<fieldset>
												<legend>Customer-Search
													<div class="pull-right" style="padding-right:20px;">
														<input type="submit" class="btn btn-primary" name="search" id="search" value="search" onclick="getaddcustomer();" style="margin-bottom: 5px;">
														 <a href="<?php echo ADMIN_URL;?>addcustomer/fileDownloadajaxcustomer/<?php if($this->input->post('customer_type')!=''){ echo $this->input->post('customer_type'); }else{ echo 0;} ?>/<?php if($this->input->post('zone')!=''){ echo $this->input->post('zone'); }else{ echo 0;} ?>/<?php if($this->input->post('fromdate')!=''){ echo $this->input->post('fromdate'); }else{ echo 0;} ?>/<?php if($this->input->post('todate')!=''){ echo $this->input->post('todate'); }else{ echo 0;} ?>
													   "class="btn btn-sm btn-primary" style="margin-bottom: 4px;">Export Excel</a><!--<a href="<?php echo ADMIN_URL;?>addcustomer/tables"class="btn btn-sm btn-primary" style="margin-bottom: 4px;">Export pdf</a>-->
													</div>
				                                </legend>
						...
						<div class="col-xs-12" id="customerDiv" style="margin-top: 13px;"></div>	
				        </div>
...
<script type="text/javascript">
		...
		function getaddcustomer(){
			...
			$.ajax({
				...
				type : "POST",
				url	: '<?php echo ADMIN_URL;?>addcustomer/getaddcustomerssearch',
