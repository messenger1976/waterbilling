<main id="js-page-content" role="main" class="page-content">
	...
	<div class="subheader">
		<h1 class="subheader-title">
			...
			Manage <span class="fw-300">Feesplaning Add</span>
		</h1>
	</div>
	...
	<div class="row">
		<div class="col-xl-12">
			<div class="panel">
				<div class="panel-hdr">
					<h2>Feesplaning Add <span class="fw-300"><i>Details</i></span></h2>
													...
													<div class="col-lg-12 controls">
														<div class="form-group"> 
															<label class="form-label">Name : </label>
																<input  class="form-control"  id="name" name="name" value="<?php echo $this->input->post('name'); ?>" required/>
												...
												<div class="form-group col-lg-6">
													<div class="col-lg-12 controls">
														<div class="form-group"> 
															...
															<input  class="form-control" id="days" name="days" value="<?php echo $this->input->post('days'); ?>" required/>
													...
													<div class="col-lg-12 controls">
														<div class="form-group"> 
															<label class="form-label"> Details :</label>
																<input  class="form-control"  id="details" name="details" value="<?php echo $this->input->post('details'); ?>" required/>
												...
												<div class="form-group col-lg-6">
													<div class="col-lg-12 controls">
														<div class="form-group"> 
															...
															<input  class="form-control"  id="amount" name="amount"  value="<?php echo $this->input->post('amount'); ?>" required/>
