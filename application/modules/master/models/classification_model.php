...
class classification_model extends CI_Model {
	public $table_name = 'tbl_classification';
    ...
    public function get_all_records() {
        $this->db->select($this->table_name.".*, ".$this->table_classification_category.".class_cat_name");
		$this->db->from($this->table_name);
		$this->db->join($this->table_classification_category, $this->table_name.'.class_cat_id = '.$this->table_classification_category.'.class_cat_id', 'left');
		$this->db->order_by($this->table_name.'.class_id','desc');
		$query = $this->db->get();
	...
	/** In Function Get classification categories for dropdown **/
    public function get_classification_categories() {
        $this->db->select("*");
		$this->db->from($this->table_classification_category);
		$this->db->order_by('class_cat_id','asc');
		$query = $this->db->get();
		$result = $query->result_array();
		return $result;
    }
	...
	public function add_record(){
		...
		$set_data = array(
						...
						'class_cat_id' => $this->input->post('class_cat_id'),
