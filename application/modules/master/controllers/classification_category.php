...
class classification_category extends CI_Controller {
	// Declare globle variable here
	
	public $headerPage = '../../views/admin-includes/header'; 
	
	public $table_name = 'tbl_classification_category';	  //*****  Table name  *****//
	public $addPage  = 'classification_category_add';	     //*****  Add page    *****//
	public $editPage = 'classification_category_edit';     //*****  Edit page   *****//
	public $listPage = 'classification_category';		   //*****  View page   *****//
	
	public $listPage_redirect = '/master/classification_category';		  //*****  Redirect View  *****//
	public $addPage_redirect = '/master/classification_category/add/';	 //*****  Redirect Add   *****//
	public $editPage_redirect = '/master/classification_category/edit/';  //*****  Redirect Edit  *****//
	public function __construct() {
        parent::__construct();
  		$this->load->model('classification_category_model','my_model');   //*****    Model Loading     *****//	
	...
	public function index(){ 		 
		...
		if(	array_key_exists('classification_category',$this->head['roleResponsible']) && $this->session->userdata('usertype') == 'subadmin' ){
			$this->top_model->get_responsibilities_conditions($this->head['roleResponsible']['classification_category']);
		}
		//*****  View Loading  *****//
