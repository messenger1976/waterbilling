...
class addjournalvoucher extends CI_Controller {
	...
	public $listPage = 'addjournalvoucher';		   //*****  View page   *****//
	public $viewPage ='addjournalvoucher_view';
	public $searchPage ='addjournalvoucher_search';
	...
	public $listPage_redirect = '/master/addjournalvoucher';		  //*****  Redirect View  *****//
	...
	public function __construct() {
        parent::__construct();
  		$this->load->model('addjournalvoucher_model','my_model');   //*****    Model Loading     *****//	
