...
class classification extends CI_Controller {
	...
	public $table_name = 'tbl_classification';	  //*****  Table name  *****//
	public $addPage  = 'classification_add';	     //*****  Add page    *****//
	public $editPage = 'classification_edit';     //*****  Edit page   *****//
	public $listPage = 'classification';		   //*****  View page   *****//
	
	public $listPage_redirect = '/master/classification';		  //*****  Redirect View  *****//
	public $addPage_redirect = '/master/classification/add/';	 //*****  Redirect Add   *****//
	public $editPage_redirect = '/master/classification/edit/';  //*****  Redirect Edit  *****//
	public function __construct() {
        parent::__construct();
  		$this->load->model('classification_model','my_model');   //*****    Model Loading     *****//	
	...
	public function index(){ 		 
		...
		if(	array_key_exists('classification',$this->head['roleResponsible']) && $this->session->userdata('usertype') == 'subadmin' ){
			$this->top_model->get_responsibilities_conditions($this->head['roleResponsible']['classification']);
		}
		//*****  View Loading  *****//
	...
	public function add(){ 
		$data['msg'] ='';
		$data['classification_categories'] = $this->my_model->get_classification_categories();
