            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(json['success'].toString() == 'N'){
                        ...
                        var output = '<div id="infobox_display"><table style="width:100%;"><tr><td style="width:70%;">';
                        output += '<div class="element_line"><strong>'+options.Name+' : </strong> '+userdata["firstname"]+' '+userdata["middlename"]+' '+userdata["lastname"]+'</div>';
                        output += '<div class="element_line"><strong>'+options.gender+' : </strong> '+userdata["gender"]+'</div>';
                        output += '<div class="element_line"><strong>'+options.dob+' : </strong> '+userdata["dob"]+'</div>';
                        output += '<div class="element_line"><strong>'+options.joindate+' : </strong> '+userdata["joiningdate"]+'</div>';
                        output += '<div class="element_line"><strong>'+options.phone1+': </strong> '+contact["phone1"]+'</div>';
                        output += '<div class="element_line"><strong>'+options.phone2+' : </strong> '+contact["phone2"]+'</div>';
                        output += '<div class="element_line"><strong>'+options.email+' : </strong> '+contact["email"]+'</div>';
